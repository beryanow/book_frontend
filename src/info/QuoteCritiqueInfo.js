...
function QuoteCritiqueInfo({book, type, setState, setNotificationActive, setNotificationMessage, changeState, setCurrentQuoteId, setRemoveQuoteActive, setEditQuoteActive, setCurrentCritiqueId, setEditCritiqueActive}) {
            ...
            {type === "critique" ? <div><CardElementField key={book.critique.id}
                    ...
                    <div style={{display: "flex", marginTop: "10px"}}>
                        <div className={"removeLabelQuote transition"}>
                            ...
                            <img className={"imgQuote transition"} src={"/removeLabelDarker.png"}
                                 onClick={() => {
                                     setCurrentQuoteId(book.critique.id);
                                     setRemoveQuoteActive(true);
                                 }}/>
                        </div>
