...
function QuoteCritiqueInfo({book, type, setState, setNotificationActive, setNotificationMessage, changeState}) {
        ...
        <div className={"quoteMainCover transition"}
            ...
            <div className={"cardTitleArea"}>
                ...
                <div className={"cardMainTitleTextPart"}>
                    ...
                    <InfoTitle className={"infoAuthorQuote"} name={book.author}/>
                </div>
            </div>
            ...
            {type === "critique" ? <CardElementField key={book.critique.id}
